...
#pragma warning(disable:4244)       // 'double'에서 'int'로 변환하면서 데이터가 손실될 수 있습니다
#pragma warning(disable:4309)       // '초기화 중' : 상수 값이 잘립니다.
#pragma warning(disable:4715)       // 모든 제어 경로에서 값을 반환하지는 않습니다
#pragma warning(disable:4800)       // 'int' : 'true' 또는 'false'로 bool 값을 강제하고 있습니다(성능 경고)
#pragma warning(disable:4805)       // '|=' : 연산에 'int' 형식과 'bool' 형식을 함께 사용하는 것은 안전하지 않습니다
...
struct CODE
{
	enum {  INTEGER=0x0002,     //16-bit integer value
